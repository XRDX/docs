...
var courseFiles = [
	...
	{
		title: "6 昼夜与四季", //课程标题
		info: "这节课的主题是《昼夜与四季》，在这节课中要让学生知道昼夜与四季的形成与地球的自转与公转相关，目的是为了练习使用动画函数和动画原理。在这节课中，学生将完成两种动画：日出（位移动画）和公转（旋转动画）。",
		preview: {PDF: "", MD: ""}, //预习资料
		handbook: "", //教师手册
		video: "", //教学视频
		ppt: "FYBNJMfy7", //教学课件
		...
		testlink: "", //答题链接
		feedback: "在本节课中，我们学习了两种动画的制作：位移动画和旋转动画。通过制作这两种动画，对动画的原理有了更深的了解，同时也练习了setInterval函数的使用。" //课后反馈
	},
	{
		title: "7 键盘钢琴", //课程标题
		info: "本节课将完成键盘钢琴项目，在本节课中学生会学习四个新的知识点：图片对象、文字对象、音频对象和键盘事件。",
		preview: {PDF: "", MD: ""}, //预习资料
		handbook: "", //教师手册
		video: "", //教学视频
		ppt: "P0k4kEgWy", //教学课件
		...
		knowledge: {PDF: "", MD: ""},  //知识小结
		testlink: "", //答题链接
		feedback: "本节课中，我们一起了解了一种新的机制：事件机制，并学习了键盘按键事件。另外，我们还学习了三种新的对象的使用：图片对象、文字对象和音频对象，利用这些知识，我们完成了一个简单的键盘钢琴，可以弹奏《小星星》。" //课后反馈
	},
	{
		title: "8 拔河大赛(1)", //课程标题
		info: "",
