...
var courseFiles = [
	{
		...
		knowledge: { //知识小结
			PDF: "http://in.leaplearner.com/file/sharing/o3QXLGltt",
			MD: "http://in.leaplearner.com/file/sharing/HkbFwaPzt"
			}, 
	...
	},
	{
		...
		knowledge: { //知识小结
			PDF: "https://rss.leaplearner.com/teachfiles/Text/Lesson 2 创意绘画(1) 知识小结及课后习题.pdf",
			MD: "https://rss.leaplearner.com/teachfiles/Text/Lesson 2 创意绘画(1) 知识小结及课后习题.md"
			}, 
	...
	for (let i in courseFiles) {
		...
		li.onclick = function() {
			...
			if (courseFiles[i]["preview"]["PDF"] !== "") {
				...
				document.getElementById("prePDF").href = courseFiles[i]["preview"]["PDF"];
			}
			else {
			...
			if (courseFiles[i]["preview"]["MD"] !== "") {
				...
				document.getElementById("preMd").href = courseFiles[i]["preview"]["MD"];
			}
			else {
			...
			if (courseFiles[i]["handbook"] !== "") {
				...
				document.getElementById("hdBook").href = courseFiles[i]["handbook"];
			}
			else {
			...
			if (courseFiles[i]["video"] !== "") {
				...
				document.getElementById("teachVideo").href = courseFiles[i]["video"];
			}
			else {
			...
			if (courseFiles[i]["ppt"] !== "") {
				...
				document.getElementById("ppt").href = courseFiles[i]["ppt"];
			}
			else {
			...
			if (courseFiles[i]["knowledge"]["PDF"] !== "") {
				...
				document.getElementById("klgPDF").href = courseFiles[i]["knowledge"]["PDF"];
			}
			else {
			...
			if (courseFiles[i]["knowledge"]["MD"] !== "") {
				...
				document.getElementById("klgMd").href = courseFiles[i]["knowledge"]["MD"];
			}
			else {
			...
			if (courseFiles[i]["testlink"] !== "") {
				...
				document.getElementById("testLink").href = courseFiles[i]["testlink"];
			}
			else {
