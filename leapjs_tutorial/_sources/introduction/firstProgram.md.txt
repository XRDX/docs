...
在代码区域写下以下代码，然后点击运行按钮，顺利的话，你可以看到画布上显示出了坐标。
...
我们把水平方向称之为x方向，把垂直方向称之为y方向，和数学常用的笛卡尔坐标系不同的是，在网页里，y方向是越往下数值越大。

#### 我们创建一个小球出来

创建一个小球，名字为`ball`，小球的中心坐标点为`(100, 100)`，大小为`25`，然后用`ball.draw`将小球画在画布上。
